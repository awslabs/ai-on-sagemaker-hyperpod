---
title : "c. Using the Helper Script"
weight : 2
---
...
:image[Helper Script Image]{src="/static/images/00-setup/helper-script.png" width=800}
...
5. AWS CloudFormation will deploy the configured workshop infrastructure, including VPC, Private Subnet, Security Group, S3 Bucket, IAM Role, and EKS Cluster resources. See [Deploy the CloudFormation Stack](/00-setup/own-account/workshop-infra/02-workshop-infra-cfn.md) for details. 
...
:::alert{header="CloudFormation Deployment Wait Time" type="info"}
...
:::alert{header="Manual HyperPod Cluster Creation" type="info"}
...
:image[Helper Script Mascot Image]{src="/static/images/00-setup/helper-script-mascot.png" width=600}

You've successfully completed the HyperPod cluster setup prerequisites and can now proceed to the [Cluster Configuration](/01-cluster) section. 

While waiting for your HyperPod cluster to create, if you're interested in learning more about what the helper script does, feel free to visit the [Additional Information](/00-setup/own-account/02-additional-info) section. 