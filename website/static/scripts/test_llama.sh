...
: ${DATASET_PATH=/scratch/ubuntu/builder_session/data/megatron-c4-sample_text_document}
...
$MAYBE_COMPILE $TORCHRUN $DISTRIBUTED_ARGS $NEMO_PATH/megatron_gpt_pretraining.py  \
    --config-path=conf \
    ...
    model.tokenizer.model=/scratch/ubuntu/builder_session/data/tokenizer.model \
