...
When following the [Step-by-Step Setup](#step-by-step-setup) below, add the `efaEnabled` parameter to your storage class configuration:
...
Ensure your PVC storage request meets the minimum requirement for your chosen throughput tier (e.g., at least 19200Gi for 250 MB/s/TiB with EFA enabled).
